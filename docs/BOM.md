...
## Optional: ROS 2 and camera control path
...
- No extra electronics are needed for the Bluetooth build. Items 1 to 5 are enough to drive the
...
- Exact SKUs and links depend on your region, so search the item names above at the Arduino
  Store (Nesso N1) and Kiraku Labo or Switch Science (BalaC base).
